...
export default class GameLevel4 extends Phaser.Scene {
  constructor() {
    super("technology-game4");
  }
  ...
  preload() {
    this.load.image("level4", "images/level4BG.jpg");
  ...
  create() {
    ...
    this.tileSprite = this.add
      .tileSprite(0, 0, 800, 450, "level4")
      .setScale(1.6)
      .setOrigin(0, 0)
      .setScrollFactor(0, 0);
    this.levelText = this.add.text(350, 10, "LEVEL 4");
