...
export default class TechnologyGame extends Phaser.Scene {
  constructor() {
    super("technology-game1");
  }
  ...
  create() {
    ...
    this.tileSprite = this.add
      .tileSprite(0, 0, 800, 450, "background")
      .setScale(1.2)
      .setOrigin(0, 0)
      .setScrollFactor(0, 0);
    this.levelText = this.add.text(350, 10, "LEVEL 1");
